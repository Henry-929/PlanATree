...
<form>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="username" class="form-control" name="username" placeholder="Userame">
    </div>
	<div class="col-sm-4"></div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
	<div class="col-sm-4"></div>
    <div class="col-sm-4">
      <button type="button" class="btn btn-primary btn-lg btn-block" onClick="getLogin('loginProcess.php', 'alert', username.value, password.value)" >Sign In</button>
    </div>
	<div class="col-sm-4"></div>
  </div>
  <div class="form-group row">
